...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $showroom = count($contact) > 5 ? $contact[5] : null;
        $phone_2 = count($contact) > 6 ? $contact[6] : null;
        $whatsapp = count($contact) > 7 ? $contact[7] : null;
        ...
        view()->share('showroom', $showroom ? $showroom['value'] : null);
