...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
        <h4 class="mb-3 mb-md-0">Jenis Postingan</h4>
    </div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('adm.index')}}">Beranda</a></li>
            <li class="breadcrumb-item active" aria-current="page">Jenis Postingan</li>
        </ol>
    </nav>
</div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5>Daftar Jenis Postingan</h5>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#createModal">
                    <i class="mdi mdi-plus"></i> Jenis Postingan
                </button>
            </div>
            <div class="card-body">
                @livewire('post.type.table')
            </div>
        </div>
    </div>
</div>

@livewire('post.type.create')
@livewire('post.type.edit')
