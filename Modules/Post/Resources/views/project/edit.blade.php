...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
        <h4 class="mb-3 mb-md-0">Edit Proyek</h4>
    </div>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="save">
                                <a class="dropdown-item" href="javascript:void(0)"
                                    ...
                                    data-action="{{route('adm.post.project.update', ['id' => $post->id, 'status' => 'draft'])}}">Draft</a>
                                <a class="dropdown-item" href="javascript:void(0)"
                                    onclick="$('form').attr('action', $(this).data('action')); document.getElementById('form').submit()"
                                    data-action="{{route('adm.post.project.update', ['id' => $post->id, 'status' => 'publish'])}}">Publish</a>
                            </div>
                        </div>
                    </div>
                </div>
