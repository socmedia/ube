<div>
    <div class="email-filters">
        ...
        <div class="row">
            <div class="col-md-6 mb-3 mb-md-0 d-flex flex-wrap justify-content-center justify-content-md-start">
                {{-- <select class="form-control py-2 mb-1 mr-1 w-auto" title="Kategori"
                    wire:model="filters.category.value">
    ...
    <div class="email-list blog">
        <div class="row my-3">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
                <div class="card border border-light shadow-none {{ $post->status_id == 3 ? 'archive' : '' }}">
                    <figure class="m-0 input d-flex justify-content-end"
                        ...
                        <div class="dropdown mr-2 mt-2 action">
                            ...
                            <div class="dropdown-menu" aria-labelledby="action">
                                <a class="dropdown-item" href="{{route('adm.post.project.edit', $post->id)}}">
                                    Edit Proyek
                                </a>

                                <a class="dropdown-item" href="{{route('adm.post.project.gallery', $post->id)}}">
                                    Galeri Proyek
                                </a>
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="{{route('adm.post.project.edit', $post->id)}}">{{ $post->title }}</a>
                        </h4>
    ...
    <x-modal id="delete-confirmation" title="Hapus proyek">
        Anda yakin akan menghapus data ini ?
        @slot('footer')
        <button type="button" class="btn btn-default text-dark shadow-sm rounded-lg" data-dismiss="modal">Batal</button>
        <button type="button" class="btn btn-danger shadow-sm rounded-lg" wire:click="destroyProject('{{$deleteID}}')">
            Hapus</button>
        @endslot
    </x-modal>
</div>
